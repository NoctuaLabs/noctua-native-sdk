#
#  Be sure to run `pod spec lint NoctuaSDK.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Noctua Labs"
  # spec.authors            = { "Noctua Labs" => "tech@noctua.gg" }
  ...
  spec.ios.source_files  = "ios/NoctuaSDK/**/*"
